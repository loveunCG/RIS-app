 ...
 */
@Component({
  selector: 'page-statistics-remote',
  templateUrl: 'statistics-remote.html',
})
export class StatisticsRemotePage {
  ...
  constructor(public navCtrl: NavController, public navParams: NavParams, public statisticsService:StatisticsProvider) {
    ...
    var query = {
      ...
      'remote_type':this.registertype,
      'chat_type':this.datetype
    };
     console.log('this is first',query)
    
    this.statisticsService.getSatisticsRemoteChart(query).subscribe((data)=>{
