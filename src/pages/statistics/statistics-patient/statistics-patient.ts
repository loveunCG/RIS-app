 ...
 */
@Component({
  selector: 'page-statistics-patient',
  templateUrl: 'statistics-patient.html',
})
export class StatisticsPatientPage {
  ...
  constructor(public navCtrl: NavController, public navParams: NavParams, public statisticsService:StatisticsProvider) {
    ...
    var query = {
      ...
      'source_type':this.registertype,
      'chat_type':this.datetype
    };
     console.log('this is first',query)
    
    this.statisticsService.getSatisticsPatientChart(query).subscribe((data)=>{
